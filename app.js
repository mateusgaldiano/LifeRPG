...
function setupEventListeners() {
    ...
    document.getElementById('rewards-list').addEventListener('click', (e) => {
        ...
        if (btn) buyReward(btn.getAttribute('data-id'));
    });
    ...
    document.getElementById('btn-add-reward').addEventListener('click', () => modalRw.style.display = 'flex');
    ...
    window.addEventListener('click', (e) => {
        ...
        if (e.target === modalRw) modalRw.style.display = 'none';
    ...
    document.getElementById('form-reward').addEventListener('submit', (e) => {
        ...
        const cost  = parseInt(document.getElementById('rw-cost').value);
        gameState.rewards.push({ id: 'rw-' + Date.now(), title, cost, icon: '🎁' });
        saveGameData(); renderRewards();
        modalRw.style.display = 'none';
